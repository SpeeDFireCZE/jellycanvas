...
(function () {
    ...
    var strings = {
        ...
        cs: {
            ...
            slideshowEnabled: 'Zobrazit slideshow', slideshowSource: 'Co ukazovat', ssRandom: 'Náhodné položky', ssLatest: 'Nedávno přidané', ssContinue: 'Pokračovat ve sledování', ssFavorites: 'Oblíbené', ssGenre: 'Žánr (název níže)', ssTag: 'Štítek (název níže)', ssNewReleases: 'Nejnovější vydání (podle premiéry)', ssMostPlayed: 'Nejsledovanější (tímto uživatelem)', ssTopRated: 'Nejlépe hodnocené', ssUnplayed: 'Ještě neviděné (náhodně)', ssMostPlayedHint: 'Jellyfin počítá přehrání zvlášť pro každého uživatele – každý tedy vidí to, co sám pouštěl nejčastěji.', ssButtonHeading: 'Tlačítko', ssButtonLabel: 'Text (prázdné = název položky)', ssButtonIcon: 'Ikona (název Material ikony, prázdné = bez ikony)', ssBtnAccent: 'Zvýrazňovací barva', ssBtnOutline: 'Obrys', ssBtnGlass: 'Sklo', ssBtnLight: 'Bílé', ssButtonRadius: 'Zaoblení rohů (-1 = jako karty)', ssButtonScale: 'Velikost',
