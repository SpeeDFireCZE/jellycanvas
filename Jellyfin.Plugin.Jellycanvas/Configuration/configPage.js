...
(function () {
    ...
    // ------------------------------------------------------------------
    var BADGE_CHIPS = { resolution: { icon: 'hd', key: 'chipResolution' }, hdr: { icon: 'hdr_on', key: 'chipHdr' }, audio: { icon: 'volume_up', key: 'chipAudio' }, subtitles: { icon: 'subtitles', key: 'chipSubtitles' } };
