...
(function () {
    ...
    page.querySelector('#jcBtnAddSeerrRow').addEventListener('click', function () {
        ...
        state.Seerr.Rows.push({ Enabled: true, Kind: 'Upcoming', Media: 'Both', Title: '', Position: 'Top', Limit: 20, ShowTitle: true, ShowSubtitle: true, ShowDate: true, ShowState: true, ShowType: false, ShowRequester: false });
        renderSeerrRows();
        scheduleScriptPreview();
    });
