...
- The preview reminds you of Ctrl+click: a hint in its corner on hover, and with Ctrl held the element under the mouse is outlined and the hint names the section a click opens.
