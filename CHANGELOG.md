...
- Item page: a banner of the item's own picture across the top (*Item page → Banner at the top*): backdrop, banner or thumb, with height, dimming and a fade into the page. Jellyfin shows one only to users who turned its own "details banner" on; this one is part of the theme.
